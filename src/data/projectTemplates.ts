...
<head>
  ...
  <title>Hello StillSkudy</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <div class="container">
    <div class="badge">StillSkudy Offline IDE</div>
...
<body>
  <main class="card">
    ...
    <div class="bio">
      Passionate about web development, algorithms, and offline-first software. Currently learning full-stack development with StillSkudy!
    </div>
...
.project-card p { color: #94a3b8; font-size: 14px; }`
      ...
      'script.js': {
        name: 'script.js',
        language: 'javascript',
        content: `console.log('Portfolio initialized successfully in StillSkudy offline sandbox.');`
      }
    }
  }
];
