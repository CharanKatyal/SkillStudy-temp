      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-slate-850 to-slate-900 border border-slate-750 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-lg">
          <div className="space-y-2">
            <h2 className="text-2xl font-extrabold text-slate-100">{selectedSkill.name}</h2>
            <p className="text-sm text-slate-300 max-w-xl leading-relaxed">{selectedSkill.description}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-bold text-slate-100">Lessons</h3>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3 truncate mr-2">
                      ...
                      <div className="truncate">
                        <h4 className="text-sm font-semibold text-slate-200 truncate">{lesson.title}</h4>
          ...
          <Card>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-bold text-slate-100">Coding Challenges</h3>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full py-2 px-3 rounded-lg bg-brand-600 hover:bg-brand-500 text-white font-semibold text-xs flex items-center justify-center gap-2 shadow-md transition"
                      >
                        <Play className="w-3.5 h-3.5 fill-current" />
                        <span>Solve in IDE Sandbox</span>
                      </button>
                    </div>
                  );
                })}
        ...
        {selectedSkill.projectIdeas.length > 0 && (
          <Card className="bg-slate-900/60 border-slate-800">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-base font-bold text-slate-100">Project Inspiration</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {selectedSkill.projectIdeas.map((idea, idx) => (
                <div
                  ...
                  className="p-3.5 rounded-xl bg-slate-850 border border-slate-850 hover:border-slate-700 cursor-pointer transition flex items-center justify-between"
                >
                  <span className="text-xs font-semibold text-slate-300">{idea}</span>
