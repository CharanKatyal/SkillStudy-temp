    ...
    >
      <div className="space-y-4 text-xs">
        <div className="p-3.5 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/50 rounded-xl flex items-start gap-2.5">
          ...
          <div>
            <h4 className="font-bold text-amber-900 dark:text-amber-200">AI Co-Pilot Status: In Development</h4>
            <p className="text-amber-800/90 dark:text-amber-400/90 text-[11px] mt-0.5 leading-relaxed">
              Skudium operates strictly without external APIs, tracking, or cloud infrastructure.
            </p>
          </div>
        </div>

        <div className="p-4 bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-750 rounded-xl space-y-2.5">
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-750 rounded-xl space-y-2">
          <h5 className="font-semibold text-slate-900 dark:text-slate-200 flex items-center gap-1.5">
