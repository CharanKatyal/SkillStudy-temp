  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      id: 'welcome-msg',
      role: 'assistant',
      content: `👋 **Hi there! I'm StillSkudy AI Tutor.**\n\nI can help you understand academic concepts, debug HTML/CSS/JavaScript in your IDE, explain practice questions, or generate a personalized study timetable!`,
